module github.com/aaronwinter/replay-celo-bug

replace github.com/aaronwinter/replay-celo-bug/counter => ./counter

go 1.17

require github.com/aaronwinter/replay-celo-bug/counter v0.0.0-00010101000000-000000000000
